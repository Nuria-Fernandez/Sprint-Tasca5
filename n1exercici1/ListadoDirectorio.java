...
public class ListadoDirectorio implements Serializable{
    ...
    public void serializar(String objetoSerializable, File rutaGuardar, String rutaRecuperar){//Necesito File porque ListadoDirectorio tiene como parametro un File
        ...
        try{
            FileOutputStream ruta = new FileOutputStream(rutaGuardar.getAbsoluteFile());//declaro la ruta donde va a ser guardado el archivo//Uso .getAbsoluteFile para que sea un String
            ...
            escribirFichero.close();//SIEMPRE HAY QUE CERRAR
            ...
            recuperarFichero.close();//SIEMPRE CERRAR
